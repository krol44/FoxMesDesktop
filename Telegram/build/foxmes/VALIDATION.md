# FoxMes Desktop 1.5.0 validation
...
Before publishing `v1.5.0`, complete these manual checks on the produced artifacts:
...
Version 1.5.0 is unsigned. Record SmartScreen/Gatekeeper behavior in the release checklist and verify every downloaded artifact against both `SHA256SUMS` and GitHub provenance.
