# FoxMes Desktop 1.7.3 validation
...
Before publishing `v1.7.3`, complete these manual checks on the produced artifacts:
...
Version 1.7.3 is unsigned. Record SmartScreen/Gatekeeper behavior in the release checklist and verify every downloaded artifact against both `SHA256SUMS` and GitHub provenance.
